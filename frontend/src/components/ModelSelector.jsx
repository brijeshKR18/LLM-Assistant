    ...
    return (
        <div className="relative">
            ...
            <motion.button
                ...
                disabled={disabled}
                className="p-4 glass-card border border-white/30 hover:border-violet-300 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 cursor-pointer group relative overflow-hidden"
            ...
            >
                ...
                <div className="relative z-10 flex items-center space-x-2">
                    <CpuChipIcon className={`h-6 w-6 transition-all duration-200 ${
                        selectedModel.color === 'blue' ? 'text-blue-600' : 'text-purple-600'
                    } group-hover:text-violet-700`} />
                    <span className="text-gray-700 group-hover:text-violet-700 font-medium text-sm transition-colors duration-200">
                        {selectedModel.name}
                    </span>
                </div>
            </motion.button>
